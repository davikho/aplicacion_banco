...
public final class ActivityIniciarSesionBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView logoBanco;
  ...
  private ActivityIniciarSesionBinding(@NonNull LinearLayout rootView,
      @NonNull Button btnInciarSesion, @NonNull ImageView logoBanco, @NonNull LinearLayout main,
      @NonNull EditText passwordInicio, @NonNull TextView tvNoTengoCuenta,
      @NonNull EditText usuarioInico) {
  ...
  public static ActivityIniciarSesionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.logoBanco;
      ImageView logoBanco = ViewBindings.findChildViewById(rootView, id);
      if (logoBanco == null) {
        break missingId;
      }
      ...
      return new ActivityIniciarSesionBinding((LinearLayout) rootView, btnInciarSesion, logoBanco,
          main, passwordInicio, tvNoTengoCuenta, usuarioInico);
    }

...
public final class ActivityCuentaUsuarioBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout imagenNombreLayout;
  ...
  @NonNull
  public final TextView tvNotaTransferencia;
  ...
  private ActivityCuentaUsuarioBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout imagenNombreLayout, @NonNull CircleImageView imagenUsuarioBuscado,
      ...
      @NonNull TextView tvNombreUsuarioB, @NonNull TextView tvNotaTransferencia,
      @NonNull TextView tvSaldoUsuario, @NonNull TextView tvTitleNumeroCuenta) {
    ...
    this.tvNotaTransferencia = tvNotaTransferencia;
  ...
  public static ActivityCuentaUsuarioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout imagenNombreLayout = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.tvNotaTransferencia;
      TextView tvNotaTransferencia = ViewBindings.findChildViewById(rootView, id);
      if (tvNotaTransferencia == null) {
        break missingId;
      }
      ...
      return new ActivityCuentaUsuarioBinding((ConstraintLayout) rootView, btnBuscarUsuario,
          ...
          layoutTransferir, main, title, tvCantidadTitle, tvNombreUsuarioB, tvNotaTransferencia,
          tvSaldoUsuario, tvTitleNumeroCuenta);
    }
